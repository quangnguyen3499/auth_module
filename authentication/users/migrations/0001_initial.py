# Generated by Django 4.1.7 on 2023-03-12 04:18
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(blank=True, choices=[('ADMIN', 'Admin'), ('TEAM', 'Team'), ('FOUNDER', 'Founder'), ('PARTNERSHIP', 'Partnership')], max_length=50, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(blank=True, choices=[('PORTFOLIO', 'Portfolio'), ('NONPORTFOLIO', 'NonPortfolio')], max_length=50, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Team',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('company', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='founder', to='users.company')),
